...
foreach ($studentList as $std) {
	...
	onclick=\'window.open("Member_EDIT.php?UID='.$std['UID'].'","_self")\'>Edit</button></td>
	<td><button class="btn btn-primary" onclick="graduatedStudent('.$std['UID'].')">Tốt nghiệp</button></td>
	<td><button class="btn btn-danger" onclick="deleteStudent('.$std['UID'].')">Delete</button></td>
		</tr>';
}
?>
					</tbody>
