...
var client = new Paho.MQTT.Client("broker.hivemq.com",8000,"web_" + parseInt(Math.random() * 100, 10));  
    ...
    console.log("Data Server2:" + DataServer);
		
		var DataJson = JSON.parse(DataServer);
    console.log("Data Server3:" + DataJson);
		//DataJson.UID.id="UID";
		//document.setcookie='UID='+DataJson.UID;
		//document.getElementById("UID").innerHTML = $UID;
		//deleteAllCookies();
		//document.cookie = 'UID='+DataJson.UID;
		//{"UID": "15666", "age": 30, "city": "New York"}
		// document.cookie = 'UID='+DataJson.UID;
    document.cookie = 'UID='+DataJson.UID;
    console.log("Data Server4:" + document.cookie);
		window.location="Form_Success.php";
